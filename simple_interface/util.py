...
def extract_vocab(dataset, rep = 'bow', n = 0):
...
def extract_features_single(tweet, vocab, rep = 'bow', n=0):
    
    #limpa e tokeniza os tweets
    cleaned_tweet = tweet_cleaner(tweet, stopwords = stopwords.words('english'), s = PorterStemmer())
    #constrói o vetor de features para cada tweet
    Xfeatures = build_features(cleaned_tweet,vocab,rep,n)
    #f = util.build_features(X[1067], vocab)
    #print(Y.shape)
